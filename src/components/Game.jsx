...
const FoodMemoryGame = ({ difficulty, resetGame }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-4">
      <div className="header flex justify-between w-full max-w-4xl">
        <button className="px-3 py-1 text-sm bg-gray-200 rounded hover:bg-gray-300 cursor-pointer" onClick={resetGame}>
          Voltar
        </button>
      ...
      <div className={`game grid ${getGridColumns()} gap-2 p-4 bg-gray-100 rounded-lg`}>
        {cards.map((card) => (
          <button key={card.id}
